...
const PathwayResourcesTab = ({ productName = "Product", pathwayNumber, showFooter = true }: PathwayResourcesTabProps) => {
  ...
  return (
    <div className="space-y-1.5">
      <button
        onClick={() => navigate(`/landscape/${category}/${topic}/value-chain/pathways/${pathwayId}/market-players`)}
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="inline-flex items-center px-1.5 py-0 rounded-md border border-muted-foreground/30 text-muted-foreground/60 text-[8px] font-normal opacity-60">Soon</span>
        </div>
