...
const defaultExt: ExtendedProfile = {
  ...
  website: "https://vcg.ai",
  linkedin: "https://linkedin.com/in/jongoriup",
  twitter: "@jongoriup",
  github: "jongoriup",
  joinedAt: "2024-01-15",
  ...
  language: "English",
  orgRole: "Super Admin",
  expertise: ["Value Chain Analysis", "Biotech", "Sustainability"],
  interests: ["AI", "Climate Tech", "Materials Science"],
  notifyEmail: true,
  notifyProduct: true,
  notifyWeekly: false,
  twoFactor: false,
