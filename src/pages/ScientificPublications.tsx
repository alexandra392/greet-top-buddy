    ...
    return (
      <div key={section.title} className="bg-muted/30 border border-border/40 rounded-xl p-4 flex flex-col">
        <div className="mb-3">
          ...
          <div className="grid grid-cols-[10px_1fr_56px_56px_14px] items-baseline gap-3 px-1.5 py-1.5 mt-2 -mx-1.5 border-y border-border/40 bg-muted/30 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">
            <span />
            <span>Categories ({totalCount})</span>
            <span className="block text-right tabular-nums text-[11px] font-bold normal-case tracking-normal text-foreground">{sectionTotal.toLocaleString()}</span>
            <span className="block text-right text-[9px] normal-case tracking-normal text-muted-foreground">100%</span>
            <span />
          </div>
        </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-primary/15">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {topTrending.map((t, i) => (
                        <div
                          key={t.topic.name}
                          className="group relative rounded-lg border border-primary/15 bg-gradient-to-br from-primary/5 to-transparent p-2 cursor-pointer hover:border-primary/40 hover:from-primary/10 hover:shadow-sm transition-all"
                        ...
                        >
                          <div className="flex items-center justify-between mb-1">
                            <div className="flex items-center gap-1">
                              <span className="flex items-center justify-center w-3.5 h-3.5 rounded-full bg-primary/15 text-[8px] font-bold text-primary">{i + 1}</span>
                        ...
                        <table className="w-full text-xs">
                          <thead>
                            <tr className="border-b border-border">
                              <th className="text-left py-1.5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Institution</th>
                              <th className="text-center py-1.5 pr-3 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Papers</th>
                              <th className="text-right py-1.5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Citations</th>
                            </tr>
                          </thead>
                          <tbody>
                            {col.map((inst) => (
