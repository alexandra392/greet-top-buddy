      ...
      <div className="bg-card border border-border/40 rounded-xl p-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="space-y-3">
            ...
            {/* Operational Plan — Coming Soon */}
            <div className="relative bg-gradient-to-br from-muted/40 via-card to-primary/5 border border-dashed border-border/60 p-3 rounded-lg overflow-hidden">
              ...
              <div className="flex items-center gap-1.5 mb-2.5">
                ...
                <h3 className="text-[10px] font-bold tracking-widest text-muted-foreground uppercase">Operational Plan</h3>
              </div>
              <p className="text-[11px] text-muted-foreground leading-relaxed mb-3 max-w-[90%]">
                Define the organisation's roadmap — milestones, quarterly objectives, resource allocation, and key deliverables.
              </p>
              <div className="grid grid-cols-3 gap-2 opacity-60">
                {[
                  { label: "Milestones", value: "—" },
                  { label: "Objectives", value: "—" },
