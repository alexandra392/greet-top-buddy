    ...
    productionSectorGroups: [
      {
        label: 'Feedstock',
        sectors: [
          { name: 'Lignocellulosic Biomass', patents: 54, share: '22.0%', cagr: '+17.8%', borderColor: 'border-l-[hsl(142,60%,40%)]', cagrColor: 'text-[hsl(142,60%,40%)]', shareColor: 'text-[hsl(142,60%,40%)]', subs: [{ n: 'Corn Stover', v: 20 }, { n: 'Wheat Straw', v: 18 }, { n: 'Wood Chips', v: 17 }, { n: 'Rice Straw', v: 14 }, { n: 'Sorghum Stalk', v: 11 }, { n: 'Bagasse', v: 9 }, { n: 'Switchgrass', v: 7 }] },
