...
import { ArrowLeft, ArrowRight, ArrowUpDown, Calendar, FileText, Filter, Download, Globe, FlaskConical, ShoppingBag, Leaf, Cpu, ChevronLeft, ChevronRight, ChevronDown, ChevronUp, Search, X, Beaker, ExternalLink, Clock } from "lucide-react";
...
import CPCExplorer from '@/components/CPCExplorer';
...
const viewConfigs: Record<PatentView, {
  ...
  feedstock: {
    ...
    cpcDescription: "Distribution of feedstock-related patents across the 3 CPC hierarchy levels (Section › Class › Subclass). Click any level to drill into its children or view the underlying patents.",
  ...
  technology: {
    ...
    cpcDescription: "Distribution of technology-related patents across the 3 CPC hierarchy levels (Section › Class › Subclass). Click any level to drill into its children or view the underlying patents.",
  ...
  production: {
    ...
    cpcDescription: "Distribution of production-related patents across the 3 CPC hierarchy levels (Section › Class › Subclass). Click any level to drill into its children or view the underlying patents.",
    ...
    productionSectorGroups: [
      {
        label: 'Feedstock',
        sectors: [
          { name: 'Lignocellulosic Biomass', patents: 128, share: '22.0%', cagr: '+17.8%', borderColor: 'border-l-[hsl(142,60%,40%)]', cagrColor: 'text-[hsl(142,60%,40%)]', shareColor: 'text-[hsl(142,60%,40%)]', subs: [{ n: 'Corn Stover', v: 20 }, { n: 'Wheat Straw', v: 18 }, { n: 'Wood Chips', v: 17 }, { n: 'Rice Straw', v: 14 }, { n: 'Sorghum Stalk', v: 11 }, { n: 'Bagasse', v: 9 }, { n: 'Switchgrass', v: 7 }, { n: 'Miscanthus', v: 7 }, { n: 'Poplar Wood', v: 6 }, { n: 'Eucalyptus Bark', v: 5 }, { n: 'Pine Residue', v: 5 }, { n: 'Hemp Hurds', v: 4 }, { n: 'Bamboo Fibre', v: 3 }, { n: 'Barley Straw', v: 2 }] },
          { name: 'Sugar Crops', patents: 45, share: '18.3%', cagr: '+14.6%', borderColor: 'border-l-[hsl(36,95%,54%)]', cagrColor: 'text-[hsl(36,95%,54%)]', shareColor: 'text-[hsl(36,95%,54%)]', subs: [{ n: 'Sugar Beet Pulp', v: 19 }, { n: 'Sugarcane Bagasse', v: 15 }, { n: 'Sweet Sorghum', v: 12 }, { n: 'Molasses', v: 10 }, { n: 'Sugar Maple', v: 8 }, { n: 'Date Syrup', v: 6 }, { n: 'Agave Nectar', v: 4 }] },
          { name: 'Starch Sources', patents: 33, share: '13.4%', cagr: '+11.2%', borderColor: 'border-l-[hsl(262,83%,58%)]', cagrColor: 'text-[hsl(262,83%,58%)]', shareColor: 'text-[hsl(262,83%,58%)]', subs: [{ n: 'Corn Starch', v: 14 }, { n: 'Potato Starch', v: 11 }, { n: 'Cassava Starch', v: 8 }, { n: 'Wheat Starch', v: 7 }, { n: 'Rice Starch', v: 5 }, { n: 'Pea Starch', v: 4 }, { n: 'Tapioca', v: 3 }] },
          { name: 'Food Waste', patents: 26, share: '10.6%', cagr: '+24.3%', borderColor: 'border-l-[hsl(195,70%,50%)]', cagrColor: 'text-[hsl(195,70%,50%)]', shareColor: 'text-[hsl(195,70%,50%)]', subs: [{ n: 'Bread Waste', v: 11 }, { n: 'Fruit Pomace', v: 8 }, { n: 'Coffee Grounds', v: 7 }, { n: 'Vegetable Peels', v: 6 }, { n: 'Dairy Whey', v: 5 }, { n: 'Spent Grain', v: 4 }, { n: 'Eggshells', v: 2 }] },
          { name: 'Algal Biomass', patents: 21, share: '8.5%', cagr: '+28.1%', borderColor: 'border-l-[hsl(170,60%,45%)]', cagrColor: 'text-[hsl(170,60%,45%)]', shareColor: 'text-[hsl(170,60%,45%)]', subs: [{ n: 'Microalgae', v: 10 }, { n: 'Macroalgae', v: 6 }, { n: 'Cyanobacteria', v: 5 }, { n: 'Spirulina', v: 4 }, { n: 'Chlorella', v: 3 }, { n: 'Diatoms', v: 2 }, { n: 'Kelp', v: 2 }] },
          { name: 'Oilseed Crops', patents: 16, share: '6.5%', cagr: '+9.8%', borderColor: 'border-l-[hsl(45,90%,50%)]', cagrColor: 'text-[hsl(45,90%,50%)]', shareColor: 'text-[hsl(45,90%,50%)]', subs: [{ n: 'Rapeseed', v: 7 }, { n: 'Soybean', v: 5 }, { n: 'Palm Kernel', v: 4 }, { n: 'Sunflower', v: 3 }, { n: 'Flaxseed', v: 2 }, { n: 'Hemp Seed', v: 2 }, { n: 'Jatropha', v: 1 }] },
          { name: 'Agricultural Residues', patents: 12, share: '4.9%', cagr: '+15.2%', borderColor: 'border-l-[hsl(30,80%,55%)]', cagrColor: 'text-[hsl(30,80%,55%)]', shareColor: 'text-[hsl(30,80%,55%)]', subs: [{ n: 'Rice Husk', v: 5 }, { n: 'Barley Straw', v: 4 }, { n: 'Oat Hulls', v: 3 }, { n: 'Corn Cobs', v: 3 }, { n: 'Cotton Stalk', v: 2 }, { n: 'Soybean Hulls', v: 2 }, { n: 'Peanut Shell', v: 1 }] },
          { name: 'Forestry Waste', patents: 9, share: '3.7%', cagr: '+11.5%', borderColor: 'border-l-[hsl(160,50%,40%)]', cagrColor: 'text-[hsl(160,50%,40%)]', shareColor: 'text-[hsl(160,50%,40%)]', subs: [{ n: 'Sawdust', v: 4 }, { n: 'Bark Residue', v: 3 }, { n: 'Logging Slash', v: 2 }, { n: 'Wood Shavings', v: 2 }, { n: 'Branch Chips', v: 1 }, { n: 'Needles', v: 1 }, { n: 'Roots', v: 1 }] },
        ]
      },
      {
        label: 'Process',
        sectors: [
          { name: 'Fermentation', patents: 70, share: '28.5%', cagr: '+20.1%', borderColor: 'border-l-[hsl(217,91%,60%)]', cagrColor: 'text-[hsl(217,91%,60%)]', shareColor: 'text-[hsl(217,91%,60%)]', subs: [{ n: 'Batch Fermentation', v: 28 }, { n: 'Continuous Fermentation', v: 22 }, { n: 'Fed-batch Systems', v: 20 }, { n: 'SSF Processes', v: 16 }, { n: 'Consolidated Bioprocessing', v: 12 }, { n: 'Solid-state Fermentation', v: 9 }, { n: 'Immobilised Cell Systems', v: 7 }] },
          { name: 'Catalytic Conversion', patents: 51, share: '20.7%', cagr: '+16.5%', borderColor: 'border-l-[hsl(195,70%,50%)]', cagrColor: 'text-[hsl(195,70%,50%)]', shareColor: 'text-[hsl(195,70%,50%)]', subs: [{ n: 'Heterogeneous Catalysis', v: 20 }, { n: 'Homogeneous Catalysis', v: 17 }, { n: 'Biocatalysis', v: 15 }, { n: 'Photocatalysis', v: 11 }, { n: 'Electrocatalysis', v: 9 }, { n: 'Zeolite Catalysis', v: 7 }, { n: 'Metal-organic Frameworks', v: 5 }] },
          { name: 'Extraction & Separation', patents: 41, share: '16.7%', cagr: '+18.7%', borderColor: 'border-l-[hsl(340,50%,55%)]', cagrColor: 'text-[hsl(340,50%,55%)]', shareColor: 'text-[hsl(340,50%,55%)]', subs: [{ n: 'Membrane Separation', v: 16 }, { n: 'Solvent Extraction', v: 14 }, { n: 'Distillation', v: 11 }, { n: 'Adsorption', v: 9 }, { n: 'Supercritical Fluid', v: 7 }, { n: 'Electrodialysis', v: 5 }, { n: 'Precipitation', v: 4 }] },
          { name: 'Purification', patents: 34, share: '13.8%', cagr: '+14.3%', borderColor: 'border-l-[hsl(36,95%,54%)]', cagrColor: 'text-[hsl(36,95%,54%)]', shareColor: 'text-[hsl(36,95%,54%)]', subs: [{ n: 'Crystallisation', v: 13 }, { n: 'Chromatography', v: 11 }, { n: 'Ion Exchange', v: 10 }, { n: 'Filtration', v: 8 }, { n: 'Evaporation', v: 6 }, { n: 'Drying', v: 5 }, { n: 'Decolourisation', v: 3 }] },
          { name: 'Enzymatic Hydrolysis', patents: 28, share: '11.4%', cagr: '+22.4%', borderColor: 'border-l-[hsl(262,83%,58%)]', cagrColor: 'text-[hsl(262,83%,58%)]', shareColor: 'text-[hsl(262,83%,58%)]', subs: [{ n: 'Cellulase Systems', v: 11 }, { n: 'Hemicellulase', v: 9 }, { n: 'Enzyme Cocktails', v: 7 }, { n: 'Lignin-degrading Enzymes', v: 6 }, { n: 'Pectinase', v: 4 }, { n: 'Amylase Blends', v: 4 }, { n: 'Protease Treatment', v: 3 }] },
          { name: 'Thermochemical', patents: 22, share: '8.9%', cagr: '+12.8%', borderColor: 'border-l-[hsl(340,50%,55%)]', cagrColor: 'text-[hsl(340,50%,55%)]', shareColor: 'text-[hsl(340,50%,55%)]', subs: [{ n: 'Pyrolysis', v: 9 }, { n: 'Gasification', v: 7 }, { n: 'Hydrothermal', v: 6 }, { n: 'Torrefaction', v: 4 }, { n: 'Combustion', v: 3 }, { n: 'Liquefaction', v: 2 }, { n: 'Steam Explosion', v: 2 }] },
          { name: 'Electrochemical', patents: 18, share: '7.3%', cagr: '+19.4%', borderColor: 'border-l-[hsl(280,60%,55%)]', cagrColor: 'text-[hsl(280,60%,55%)]', shareColor: 'text-[hsl(280,60%,55%)]', subs: [{ n: 'Electrolysis', v: 8 }, { n: 'Electrodialysis', v: 6 }, { n: 'Redox Systems', v: 4 }, { n: 'Fuel Cells', v: 3 }, { n: 'Corrosion Inhibition', v: 2 }, { n: 'Electrocoagulation', v: 2 }, { n: 'Biosensors', v: 1 }] },
          { name: 'Hybrid Bioprocessing', patents: 14, share: '5.7%', cagr: '+24.8%', borderColor: 'border-l-[hsl(50,90%,45%)]', cagrColor: 'text-[hsl(50,90%,45%)]', shareColor: 'text-[hsl(50,90%,45%)]', subs: [{ n: 'Photo-fermentation', v: 6 }, { n: 'Chemo-enzymatic', v: 5 }, { n: 'Cell-free Systems', v: 3 }, { n: 'Synthetic Biology', v: 3 }, { n: 'Co-culture Systems', v: 2 }, { n: 'Biorefinery Integration', v: 2 }, { n: 'Waste-to-product', v: 1 }] },
        ]
      }
    ],
  ...
  applications: {
    ...
    cpcDescription: "Distribution of application-related patents across the 3 CPC hierarchy levels (Section › Class › Subclass). Click any level to drill into its children or view the underlying patents.",
  ...
  products: {
    ...
    cpcDescription: "Distribution of material-related patents across the 3 CPC hierarchy levels (Section › Class › Subclass). Click any level to drill into its children or view the underlying patents.",
            ...
            <div className="flex-1 overflow-y-auto max-h-[calc(100vh-200px)]">
               <div className="space-y-3">
                ...
                <div className="grid grid-cols-12 gap-3 relative">
                    <div className="col-span-12 bg-muted/30 border border-border/40 rounded-xl p-4 relative overflow-hidden">
                      ...
                      {activeConfig.productionSectorGroups ? (
                                  ...
                                  <div key={sector.name} onClick={() => { setSubItemsParent(group.label); setSubItemsModal(sector); }} className={`border-l-4 ${sector.borderColor} bg-background rounded-lg p-3 cursor-pointer hover:bg-muted/40 transition-colors shadow-sm`}>
                                    ...
                                    <div className="space-y-1">
                                      ...
                                      {sector.subs.length > 2 && (
                                        <div className="text-[9px] font-semibold text-primary pt-0.5">+{sector.subs.length - 2} more</div>
                                      )}
                                    </div>
                                  </div>
                                )}
                        ...
                        <>
                          {activeConfig.sectors.slice(0, expandFlatRows ? activeConfig.sectors.length : 2).map((row, rowIdx) =>
                          ...
                          {activeConfig.sectors.length > 2 && (
                            <div className="flex justify-end mt-2">
                              <button
                                type="button"
                                onClick={() => setExpandFlatRows(!expandFlatRows)}
                                className="flex items-center gap-1 text-[9px] font-semibold text-muted-foreground hover:text-foreground transition-colors px-2 py-1 rounded-md border border-border/60 hover:border-border hover:bg-muted/30 bg-background/50"
                              >
                                {expandFlatRows ? 'Show Less' : `View All (${activeConfig.sectors.length * 3} categories)`} <ChevronDown className={`w-2.5 h-2.5 transition-transform ${expandFlatRows ? 'rotate-180' : ''}`} />
                              </button>
                            </div>
                          )}
                        </>
                ...
                <div className="space-y-3">
                  ...
                  <CPCExplorer
                    cpcData={cpcCategories}
                    topic={decodedTopic || 'Lactic Acid'}
                    title={`Patent Distribution by CPC – ${activeConfig.label}`}
                    description={activeConfig.cpcDescription}
                  />
                </div>
